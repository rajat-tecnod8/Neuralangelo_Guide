...
curl -s -L https://nvidia.github.io/nvidia-docker/$distribution/nvidia-docker.list | sudo tee /etc>

sudo apt-get update
sudo apt-get install -y nvidia-docker2

echo "All modules installed. Restarting docker."
sudo systemctl restart docker

echo "Running example image : Hello World"
